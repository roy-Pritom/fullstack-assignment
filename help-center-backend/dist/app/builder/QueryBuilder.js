...
class QueryBuilder {
    ...
    filter() {
        ...
        // Initialize priceQuery as any to bypass TypeScript checks
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const priceQuery = {};
        if (this.query.minPrice !== undefined) {
            priceQuery.price = Object.assign(Object.assign({}, priceQuery.price), { $gte: this.query.minPrice });
        }
        if (this.query.maxPrice !== undefined) {
            priceQuery.price = Object.assign(Object.assign({}, priceQuery.price), { $lte: this.query.maxPrice });
        }
        // Cast priceQuery to FilterQuery<T> when using it
        this.modelQuery = this.modelQuery.find(priceQuery);
    ...
    paginate() {
        ...
        const limit = Number((_b = this === null || this === void 0 ? void 0 : this.query) === null || _b === void 0 ? void 0 : _b.limit) || 200;
